...
button_sfx_1 = pygame.mixer.Sound("sounds/beep_1.wav")
button_sfx_2 = pygame.mixer.Sound("sounds/beep_2.wav")
button_sfx_3 = pygame.mixer.Sound("sounds/beep_3.wav")
...
class Button():
    ...
    def __init__(self, image, x_pos, y_pos, text_input, switch=False, alt_image=None):
        self.image = image
        self.x_pos = x_pos
        self.y_pos = y_pos
    ...
    def CheckForInput(self, position):
        ...
        if self.rect.collidepoint(position):
            [button_sfx_1, button_sfx_2, button_sfx_3][np.random.randint(0,3)].play()
